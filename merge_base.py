...
def get_args():
    ...
    parser.add_argument("--base_model_name_or_path", type=str, default="ybelkada/falcon-7b-sharded-bf16")
    parser.add_argument("--peft_model_path", type=str, default="sert121/falcon_spider_v1")
    parser.add_argument("--output_dir", type=str, default="./new_model")
